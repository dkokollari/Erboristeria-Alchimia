...
if (isset($_GET['action']) && $_GET['action'] == 'productRemoved') $contenuto = str_replace('<ul class="adjust_margins">', '<ul class="adjust_margins">' . "\n" . '<p class="addedProduct">Prodotto rimosso dal carrello con successo</p>' . "\n", $contenuto);
