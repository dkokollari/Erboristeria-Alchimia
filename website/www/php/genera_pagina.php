...
class Genera_pagina
{
    ...
    public function genera($base, $target, $contenuto="") {
      ...
      switch($target) {
        case "admin" :
          ...
          $attributi_body = 'class="container admin"';
          $header_background = '';
        ...
        case "carrello" :
          ...
          $attributi_body = 'class="container carrello"';
          $header_background = '';
          $icona_top = "";
        ...
        case "form_eventi" :
          ...
          $attributi_body = 'class="container form_eventi"';
          $header_background = '';
          $lista_menu = menu_pagina::menu();
        ...
        case "profilo" :
          ...
          $attributi_body = 'class="container profilo"';
          $header_background = '';
          $lista_menu = menu_pagina::menu($target);
        ...
        case "registrazione" :
          ...
          $attributi_body = 'class="container registrazione"';
          $header_background = '';
          $lista_menu = menu_pagina::menu();
          $script_body = '<script src="../javascript/validate_form.js"></script>
                          <script src="../javascript/date-input-polyfill.dist.js"></script>';
        ...
        case "redirect" :
          ...
          $attributi_body = 'class="container redirect"';
          $header_background = '';
          $lista_menu = menu_pagina::menu();
        break;
        case "teinfusi" :
    ...
    $pagina = str_replace("%ICONA_TOP%", $icona_top, $pagina);
    if ($base == "../html/base5.html") $lista_menu = str_replace("xml:lang", "lang", $lista_menu);
    $pagina = str_replace("%LISTA_MENU%", $lista_menu, $pagina);
    $pagina = str_replace("%CONTENUTO_PAGINA%", $contenuto, $pagina);
    $pagina = str_replace("%SCRIPT_BODY%", $script_body, $pagina);
    if ($base == "../html/base5.html") $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . htmlentities("://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]", ENT_DISALLOWED);
    $pagina = str_replace("%ACTUAL_LINK%", $actual_link, $pagina);
    return $pagina;
  }
